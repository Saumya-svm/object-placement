...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_root", type=str, default="new_OPA", help="dataset root")
    ...
    parser.add_argument("--epoch", type=int, default=11, help="which epoch to evaluate", required=False)
    parser.add_argument("--repeat", type=int, default=1, help="number of times to sample different random vectors")
    parser.add_argument("--category", type=str, default='person', help="category of the foreground")
